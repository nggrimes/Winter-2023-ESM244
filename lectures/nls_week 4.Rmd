...
.pull-right[
[Agriculture:](https://www.tandfonline.com/doi/epdf/10.1080/09535314.2014.926266?needAccess=true&role=button) $y=\gamma(\sum^n_{i=1}\alpha_ix_i^{-\rho})^\frac{1}{-\rho}$

(Production elasticity)

[Economics](https://academic.oup.com/icesjms/article/40/3/211/620770) $l_t=L_{\infty}(1-exp[-k(x-t_0)])$

(von Vertalanffy growth)
